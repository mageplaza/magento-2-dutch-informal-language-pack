...
- We will merge `github_contributions.csv` with [nl_NL.csv](https://github.com/mageplaza/magento-2-dutch-informal-language-pack/blob/master/nl_NL.csv). Your Magento 2 store will use this csv file.
